...
int main()
{
	...
	try
	{
		std::cout << "\n[Order]: Boss asks for a 'shrubbery creation' on 'Garden'" << std::endl;
	...
	try
	{
		std::cout << "\n[Order]: Boss asks for a 'presidential pardon' on 'Criminal'" << std::endl;
	...
	{
		std::cerr << "\033[31m[Expected Error]: " << e.what() << "\033[0m" << std::endl;
	}
